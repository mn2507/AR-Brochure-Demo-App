package com.app.arbrochuredemoapp.sceneform

import android.content.Context
import android.net.Uri
import android.util.Log
import com.google.ar.core.AugmentedImage
import com.app.arbrochuredemoapp.sceneform.AugmentedImageNode
...
class AugmentedImageNode(context: Context?, filename: String?) : AnchorNode() {
    ...
    fun setImage(image: AugmentedImage) {
        ...
        if (!modelFuture!!.isDone) {
            CompletableFuture.allOf(modelFuture).thenAccept { aVoid: Void? -> setImage(image) }
